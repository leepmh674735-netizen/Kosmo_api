  ...
  return (
    <div className="container" style={{ padding: '40px 24px' }}>
      ...
      <div className="section-header">
        <span className="font-serif" style={{ fontSize: '14px', color: 'var(--primary-gold)', fontWeight: '700', letterSpacing: '2px', textTransform: 'uppercase' }}>ATELIER MENU</span>
        <h2 className="text-gradient">밀아틀리에 식빵소개</h2>
        <p>엄선된 유기농 원료와 24시간의 기다림으로 완성되는 아틀리에 수제 식빵 라인업입니다.</p>

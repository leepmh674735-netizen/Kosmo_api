...
public class HomeController {
	...
	public String getList(Model model) {
		var members = List.of(
				...
				Member.builder().name("공미영").email("MinyeongKong@hanbit.co.kr").age(23).build(),
				Member.builder().name("김도윤").email("DOYenKim@hanbit.co.kr").age(10).build()
		);
